...
public class RoleApi extends BaseController<RolePO, RoleQO> {
    ...
    @RequestMapping("list")
    public CommonResult<List<RolePO>> list(@ModelAttribute("pojo")RoleQO q) {
    ...
    public CommonResult<Boolean> update(@RequestBody RolePO t) {
    ...
    public CommonResult<Boolean> insert(@RequestBody RolePO t) {
    ...
    public CommonResult<Boolean> logicDelete(@RequestParam("id") Long id) {
        return roleService.logicDelete(id);
    }
