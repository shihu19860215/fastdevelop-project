...
@RestController
@RequestMapping("/customeractivitymapping")
@Slf4j
public class CustomerActivityMappingController extends BaseController<CustomerActivityMappingPO, CustomerActivityMappingQO> {
